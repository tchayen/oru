  ...
  it("replays a create op", () => {
    const ops: OplogEntry[] = [
      makeOp({
        ...
        op_type: "create",
        field: null,
        value: JSON.stringify({ title: "Buy milk", status: "todo", priority: "medium", labels: [], notes: [], metadata: {} }),
      }),
    ];
    replayOps(db, ops);
  ...
  it("replays an update op", () => {
    ...
    replayOps(db, [
      makeOp({
        ...
        op_type: "create",
        field: null,
        value: JSON.stringify({ title: "Task", status: "todo", priority: "medium", labels: [], notes: [], metadata: {} }),
  ...
  it("per-field resolution: different fields from different devices both kept", () => {
    replayOps(db, [
      makeOp({
        ...
        op_type: "create",
        field: null,
        value: JSON.stringify({ title: "Task", status: "todo", priority: "low", labels: [], notes: [], metadata: {} }),
        timestamp: "2024-01-01T00:00:00.000Z",
      }),
      makeOp({
        id: "op-2",
