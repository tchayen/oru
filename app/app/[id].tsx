    ...
    <>
      ...
      >
        ...
        <View style={{ gap: 8 }}>
          ...
          <SegmentedControl
            values={STATUSES.map((s) => STATUS_LABELS[s])}
            selectedIndex={STATUSES.indexOf(task.status)}
            onChange={({ nativeEvent }) => handleStatusChange(nativeEvent.selectedSegmentIndex)}
          />
        </View>
        ...
        <View style={{ gap: 8 }}>
          ...
          <SegmentedControl
            ...
            onChange={({ nativeEvent }) => handlePriorityChange(nativeEvent.selectedSegmentIndex)}
          />
        </View>
