...
complete -c ao -n __ao_needs_command -a context -d 'Show agent briefing of current task status'
...
complete -c ao -n '__ao_using_command context' -l owner -d 'Scope briefing to a specific owner' -r
complete -c ao -n '__ao_using_command context' -l json -d 'Output as JSON'
complete -c ao -n '__ao_using_command context' -l plaintext -d 'Output as plain text'
