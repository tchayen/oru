    ...
    "add_task",
    {
      ...
      inputSchema: z.object({
        ...
        id: z
          ...
          .optional()
          .describe(
            "Custom task ID for idempotent creates. If a task with this ID already exists, the existing task is returned. Must be a 22-character base62 string (alphabet: 0-9, A-Z, a-z).",
          ),
